...
|---------------------------|--------------|-----------|
| UCSBDiningCommonsMenuItem |   Tim        |  yoonseo642        |
| UCSBOrganization          |  Jackson     |  sidushdid         |
| RecommendationRequest     |  Yulin       |  yulin-Y           |
| MenuItemReview            |  Amy         |  amyli2027         |
| HelpRequest               |  Hao         |  LemoNaCl          |
| Articles                  |  Nataly      |  n-ornelas         |
